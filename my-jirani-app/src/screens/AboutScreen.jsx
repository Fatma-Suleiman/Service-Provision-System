      ...
      <div className="text-center mb-4">
        <img 
          ...
          style={{
            ...
            height: "350px",
            objectFit: "cover",
            border: "5px solid #0056b3"      // secondary color
          }}
        />
      </div>
            ...
            <div key={index} className="col-md-4">
              <div 
                ...
                style={{
                  ...
                  cursor: "pointer",
                  borderColor: "#1588ce"      // subtle accent
                }}
                onMouseEnter={e => e.currentTarget.style.transform = 'translateY(-5px)'}
                onMouseLeave={e => e.currentTarget.style.transform = 'translateY(0)'}
              >
                <div className="card-body">
                  <h5 className="card-title" style={{ color: "#0056b3" }}>
                    {item.title}
                  </h5>
        ...
        <ul className="list-group list-group-flush">
          {[
            ...
            <li
              ...
              onMouseEnter={e => e.currentTarget.style.backgroundColor = '#e9ecef'}  // a bit darker grey
